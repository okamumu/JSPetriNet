...
import jspetrinet.ast.ASTAnd;
import jspetrinet.ast.ASTDivide;
import jspetrinet.ast.ASTEq;
import jspetrinet.ast.ASTGt;
import jspetrinet.ast.ASTGte;
import jspetrinet.ast.ASTIfThenElse;
import jspetrinet.ast.ASTLt;
import jspetrinet.ast.ASTLte;
import jspetrinet.ast.ASTMinus;
import jspetrinet.ast.ASTMod;
import jspetrinet.ast.ASTMulti;
import jspetrinet.ast.ASTNeq;
import jspetrinet.ast.ASTNot;
import jspetrinet.ast.ASTNumOfToken;
import jspetrinet.ast.ASTOr;
import jspetrinet.ast.ASTPlus;
import jspetrinet.ast.ASTUnaryMinus;
import jspetrinet.ast.ASTValue;
import jspetrinet.ast.ASTVariable;
import jspetrinet.ast.ASTree;
import jspetrinet.exception.ASTException;
import jspetrinet.exception.AlreadyExistException;
import jspetrinet.exception.NotFindObjectException;
import jspetrinet.exception.UnknownOption;
...
for (PairValue pval : optlist.getList()) {
  ...
  final public void UniformTransDeclaration() throws ParseException, ASTException {Token token;
        PairValueList optlist;
    jj_consume_token(GENTRANS);
    token = jj_consume_token(IDENTIFIER);
current.createGenTrans(token.image,
                new ASTValue(token.image), UnifTrans.DefaultPolicy);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OPEN:{
      jj_consume_token(OPEN);
      optlist = OptionList();
for (PairValue pval : optlist.getList()) {
                        String label = pval.getLabel();
                        ASTree value = pval.getValue();
                        UnifTrans tr = (UnifTrans) current.getTrans(token.image);
  ...
  private boolean jj_3R_10()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7eafbc0,0x7cafbc0,0x200000,0x0,0x7cafbc0,0x7cafbc0,0x200000,0x0,0x0,0x27bc0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x7c08000,0x1,0x7c08000,0x0,0x40000000,0x80000000,0x0,0x0,0x0,0x0,0x6000000,0x6000000,0x38000000,0x38000000,0x7c08000,0x1c08000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x3781,0x781,0x0,0x3000,0x781,0x781,0x0,0x3000,0x3000,0x0,0x1000,0x400,0x400,0x400,0x400,0x400,0x400,0x400,0x400,0x400,0x4000,0x2000,0x781,0x3000,0x781,0x18000,0x0,0x0,0x6,0x6,0x78,0x78,0x0,0x0,0x0,0x0,0x781,0x780,};
   }
